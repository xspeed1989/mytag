...
RUN apt-get -o Acquire::Check-Valid-Until=false update \
    ...
    build-essential libpq-dev cron git libopenblas-dev liblapack-dev libatlas-base-dev libblas-dev gfortran zlib1g-dev libopenblas-dev cmake \
     --yes
...
RUN apt-get install -y libxml2-dev libxslt-dev zlib1g-dev libopenblas-dev cmake 
WORKDIR /app
